    ...
    <div class="col-lg-8 u4 u4-2-1">
        <div class="card m-b-5">
            ...
            <ul class="nav nav-tabs customtab" role="tablist">
                ...
                <?php } ?>
                <form id="form-venta-rapida" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>venta/pedido_create/pc2">
                    <input type="hidden" class="form-control input-mayus bg-t" name="nomb_cliente" value="VENTA RAPIDA - ADMIN" autocomplete="off"/>
                    <li class="nav-item tab04"><a class="nav-link"><button class="btn btn-xs btn-primary hidden-xs-down">VENTA RAPIDA</button></a></li> 
                </form>
            </ul>
            <!-- Tab panes -->
                ...
                <div class="row floating-labels" style="margin-left: 0px; margin-right: 0px;">
                    ...
                    <div class="col-sm-6 bg-header b-l">
                        ...
                        <div class="form-group m-b-30">
                            ...
                            <span class="bar"></span>
                            <label for="cod_mesa_destino_opc01">Mesa</label>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <input type="hidden" name="tipo_cliente" id="tipo_cliente">
            <div class="modal-header justify-center">
                ...
                <div class="ml-auto m-t-10">
                    <input name="tipo_cli" type="radio" value="1" id="td_ci" class="with-gap radio-col-light-green"/>
                    <label for="td_ci"><?php echo Session::get('diAcr'); ?></label>
                    <input name="tipo_cli" type="radio" value="2" id="td_nit" class="with-gap radio-col-light-green"/>
                    <label for="td_nit"><?php echo Session::get('tribAcr'); ?></label>
                </div>
            </div>
                        ...
                        <div class="row card-body p-0">
                            ...
                            <div class="col-md-6 block01" style="display: block;">
                                <div class="form-group ent m-b-40">
                                    <input type="text" class="form-control ci" name="ci" id="ci" minlength="<?php echo Session::get('diCar'); ?>" maxlength="<?php echo Session::get('diCar'); ?>" value="" autocomplete="off" required="required"/>
                                    <span class="bar"></span>
                                    <label for="ci" class="c-ci"><?php echo Session::get('diAcr'); ?></label>
                                </div>
                            </div>
                            <div class="col-md-6 block02" style="display: none;">
                                <div class="form-group ent m-b-40">
                                    <input type="text" class="form-control nit" name="nit" id="nit" minlength="<?php echo Session::get('tribCar'); ?>" maxlength="<?php echo Session::get('tribCar'); ?>" value="" autocomplete="off" required="required"/>
                                    <span class="bar"></span>
                                    <label for="nit" class="c-nit"><?php echo Session::get('tribAcr'); ?></label>
                                </div>
                            </div>
                            <div class="col-md-12 block07" style="display: none;">
                                <div class="form-group letNumMayMin m-b-40">
                                    <input type="text" class="form-control nit input-mayus" name="razon_social" id="razon_social" value="" autocomplete="off" required="required"/>
                                    <span class="bar"></span>
                            ...
                            <div class="col-md-12 block03" style="display: block;">
                                <div class="form-group letMayMin m-b-40">
                                    <input type="text" class="form-control ci input-mayus" name="nombres" id="nombres" value="" autocomplete="off" required="required"/>
                                    <span class="bar"></span>
                            ...
                            <div class="col-md-6 block04" style="display: block;">
                                <div class="form-group letMayMin m-b-40">
                                    <input type="text" class="form-control ci input-mayus" name="ape_paterno" id="ape_paterno" value="" autocomplete="off" required="required"/>
                                    <span class="bar"></span>
                            ...
                            <div class="col-md-6 block04" style="display: block;">
                                <div class="form-group letMayMin m-b-40">
                                    <input type="text" class="form-control ci input-mayus" name="ape_materno" id="ape_materno" value="" autocomplete="off" required="required"/>
                                    <span class="bar"></span>
                    ...
                    <div class="col-lg-6">
                        <div class="row card-body bg-header p-0">
                            ...
                            <div class="col-md-6 block05" style="display: block;">
                                <div class="form-group m-b-40">
                                    <input type="text" class="form-control bg-transparent ci input-mayus" name="fecha_nac" id="fecha_nac" value="" autocomplete="off" data-mask="99-99-9999"/>
                                    <span class="bar"></span>
                            ...
                            <div class="col-md-12 block06" style="display: block;">
                                <div class="form-group m-b-40">
                                    <input type="text" class="form-control bg-transparent ci" name="correo" id="correo" value="" autocomplete="off"/>
                                    <span class="bar"></span>
