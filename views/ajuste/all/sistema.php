	    ...
	    <div class="card p-20">
            ...
            <div class="vtabs customvtab">
                <ul class="nav nav-tabs tabs-vertical" role="tablist" >
                    ...
                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#step4" role="tab" aria-selected="false"><span class="hidden-sm-up"><i class="ti-desktop"></i></span> <span class="hidden-xs-down">Servidor Impresión</span> </a> </li>
                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#step5" role="tab" aria-selected="false"><span class="hidden-sm-up"><i class="ti-printer"></i></span> <span class="hidden-xs-down">Modalidad Impresión</span> </a> </li>
					<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#step6" role="tab" aria-selected="false"><span class="hidden-sm-up"><i class="ti-settings"></i></span> <span class="hidden-xs-down">Configuración adicional</span> </a> </li>
                </ul>
                <!-- Tab panes -->
                ...
                <div class="tab-content">
			                        ...
			                        <div class="row">
			                            <div class="col-md-6">
			                                <div class="form-group m-b-40 letNumMayMin">
			                                    ...
			                                    <span class="bar"></span>
			                                    <label for="trib_acr">Nomenclatura <span class="label label-info font-13">EJEMPLO: NIT, RUT, RIF</span></label>
			                                </div>
			                            </div>
			                            <div class="col-md-6">
			                        ...
			                        <div class="row">
			                            <div class="col-md-6">
			                                <div class="form-group m-b-40 letNumMayMin">
			                                    ...
			                                    <span class="bar"></span>
			                                    <label for="di_acr">Nomenclatura <span class="label label-info font-13">EJEMPLO: CI, RG</span></label>
			                                </div>
			                            </div>
			                            <div class="col-md-6">
			                                <div class="form-group m-b-40 ent">
			                        ...
			                        <div class="row">
			                            ...
			                            <div class="col-md-6">
			                                <div class="form-group m-b-40 dec">
												...
												<select class="selectpicker form-control" name="imp_val" id="imp_val" data-style="form-control btn-default" data-size="5" data-live-search-style="begins" data-live-search="true" autocomplete="off" required="" tabindex="-98">
                                                    <option value="0.18">18%</option>
													<option value="0.18">14%</option>
			                        ...
			                        <div class="row">
			                            <div class="col-md-6">
			                                <div class="form-group m-b-40">
			                                    ...
			                                    <span class="bar"></span>
			                                    <label for="mon_acr">Nomenclatura <span class="label label-info font-13">EJEMPLO: BOLIVIANOS, PESOS.</span></label>
			                                </div>
			                            </div>
			                            <div class="col-md-6">
			                                <div class="form-group m-b-40">
                    ...
                    <div class="tab-pane" id="step4" role="tabpanel">
						<div class="p-20">
                            <div class="row floating-labels">
	                            <div class="col-md-12">
	                            	<h4 class="card-title"><i class="ti-desktop font-18"></i> Servidor o PC Impresión</h4>
			                        <h6 class="card-subtitle">Ingresar el HOSTNAME del equipo y la IP asignada en la red LAN donde tambien deben estar conectadas las impresoras.</h6><br>
			                        <div class="row">
			                            <div class="col-md-6">
			                                <div class="form-group m-b-40">
			                                    <input type="text" name="pc_name" id="pc_name" class="form-control" autocomplete="off" required>
			                                    <span class="bar"></span>
			                                    <label for="pc_name">Hostname</label>
			                                </div>
			                            </div>
			                            <div class="col-md-6">
			                                <div class="form-group m-b-40">
                            ...
                            <div class="row floating-labels">
	                            <div class="col-md-12">
			                        ...
			                        <div class="row pt-4">
			                            <div class="col-md-6">
			                                <div class="form-group m-b-40">
			                                    <input type="text" name="cod_seg" id="cod_seg" class="form-control" autocomplete="off" required>
			                                    <span class="bar"></span>
										...
										<div class="col-md-6">
											<div class="form-group m-b-40">
												...
												<div class="row">
													<div class="col-8">
													<h6 class="text-muted mt-3">GLOVO,RAPPI,PEDIDOSYA, ETC</h6>
													</div>
