                    ...
                    <div class="tab-pane p-0 active" id="tab1" role="tabpanel">
                        <div class="row text-center m-t-0 p-l-10 p-r-10">
                            <div class="col-6 m-t-20">
                                <h2 class="m-b-0 font-30 text-warning  font-normal mesas-operaciones"></h2>
                                <h6 class="font-bold m-b-10">N° Mesas por cobrar</h6>
                            </div>
                            <div class="col-6 m-t-20">
                                <h2 class="m-b-0 font-30 text-warning font-normal mesas-total"></h2>
                        ...
                        <div class="card-body p-b-0"><br>
                            <div class="message-box contact-box">
                                <div class="row floating-labels">
                                    ...
                                    <div class="col-sm-6 col-lg-4 m-b-40">
