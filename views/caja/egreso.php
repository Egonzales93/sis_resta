                    ...
                    <div class="col-4 col-sm-4 col-lg-4">
                        <div class="row text-center m-t-0 p-l-10 p-r-10">
                            <div class="col-lg-5 col-md-6 col-sm-12 m-b-20">
                                <h2 class="m-b-5 font-30 text-warning font-normal egresos-total"></h2><h6 class="font-bold">Total</h6>
                            </div>
                            <div class="col-lg-5 col-md-6 col-sm-12">
                                <h2 class="m-b-5 font-30 text-warning font-normal egresos-oper"></h2><h6 class="font-bold">N° Operaciones</h6>
                            </div>
                        </div>
                    </div>
