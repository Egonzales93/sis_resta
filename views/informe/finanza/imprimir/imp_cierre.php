...
foreach($this->dato->Pagos as $d){ 
	$pdf->Cell(32, 4, $d->DESCRIPCION, 0);   
	$pdf->Cell(15, 4, $d->TRANSACCIONES,0,0,'R');
	$pdf->Cell(25, 4, number_format(($d->MONTO),2),0,0,'R');
	$pdf->Ln(4);
}
...
// print_r($friendsByAge);

// PRODUCTOS
// foreach($this->dato->Detalle as $d){

// $pdf->SetFont('Courier', '', 8);
// $pdf->MultiCell(42,4,utf8_decode($d->Producto->pro_cat),0,'L');
