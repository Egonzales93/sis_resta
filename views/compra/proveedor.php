        ...
        <input type="hidden" name="id_prov" id="id_prov">
            ...
            <div class="modal-body">
                <div class="row floating-labels m-t-0">
                    ...
                    <div class="col-md-6">
                        <div class="form-group ent m-b-40">
                            <input type="text" class="form-control ci" name="telefono" id="telefono" value="" autocomplete="off"/>
                            <span class="bar"></span>
                    ...
                    <div class="col-md-12">
                        <div class="form-group m-b-40">
                            <input type="text" class="form-control ci" name="email" id="email" value="" autocomplete="off"/>
                            <span class="bar"></span>
