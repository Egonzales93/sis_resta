...
$fechaa = date("m-Y");
?>
<input type="hidden" id="iva" value="<?php echo number_format(Session::get('iva'),2); ?>"/>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row floating-labels m-t-20">
                            <div class="col-sm-6">
                                <div class="form-group m-b-40 ent">
                                    <input type="text" name="nit" id="nit" minlength="<?php echo $_SESSION["tribCar"]; ?>" maxlength="<?php echo $_SESSION["tribCar"]; ?>" class="form-control" autocomplete="off" required/>
                                    <span class="bar"></span>
                                    <label for="nit" class="c-nit"><?php echo $_SESSION["tribAcr"]; ?></label>
                                </div>
                            </div>
                            <div class="col-sm-6">
