...
$(function() {
    ...
    var idMesa = localStorage.getItem("id_mesa");
    //alert('ok 2: ' + idMesa);
    ...
    if (idMesa != null && idMesa !== "") {
        ...
        //localStorage.setItem("id_mesa", 1);
        mesa_list(1);
        console.log('ID MESA DEFAULT: 1');
    }

    //REFRESCAMOS CADA 20 SEGUNDOS
    setInterval(function() {
        mesa_list(localStorage.getItem("id_mesa"));
    }, 20000);
                ...
                success: function (data) {
                    response($.map(data, function (item) {
                        ...
                        return {
                            ...
                            //label: tipo_cli+': '+item.ci+''+item.nit,
                            value: item.telefono
                        }
                    }))
                }
...
var mesa_list = function(cod){
    localStorage.setItem("id_mesa", cod);
    console.log('ID MESA REFRESH: ' + cod);
...
var enviar_whatsapp_pago = function(nro_pedido,total_pedido,cliente,telefono){
    ...
    Swal.fire({
        ...
        showLoaderOnConfirm: true,
        preConfirm: function() {
            window.open('https://api.whatsapp.com/send?phone=591'+telefono+'&text='+$('#textarea').val() ,'_blank');
        }            
    });
}
