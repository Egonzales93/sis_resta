                        ...
                        <div class="row floating-labels m-t-40">
                            <div class="col-md-6">
                                <div class="form-group ent m-b-40">
                                    <input type="text" class="form-control" name="ci" id="ci" value="<?php echo $r = (isset($this->usuario['ci'])) ? $this->usuario['ci'] : ''; ?>" autocomplete="off" minlength="<?php echo Session::get('diCar'); ?>" maxlength="<?php echo Session::get('diCar'); ?>" required="required"/>
                                    <span class="bar"></span>
