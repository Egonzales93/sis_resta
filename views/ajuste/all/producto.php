...
<div class="modal inmodal" id="modal-presentacion" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="true">
    <div class="modal-dialog modal-lg">
        ...
        <input type="hidden" name="id_pres_presentacion" id="id_pres_presentacion">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-5 b-r">
                        ...
                        <div class="row floating-labels">
                            <div class="col-sm-6 m-t-20 m-b-20">
                            ...
                            <div class="col-sm-6 m-t-20 m-b-20" id="tp-1" style="display: none">
                            ...
                            <div class="col-sm-6 m-t-20 m-b-20" id="tp-2" style="display: none">
                            ...
                            <div class="col-sm-6 m-t-20 m-b-20" id="">
                                <input type="hidden" name="hidden_impuesto_presentacion" id="hidden_impuesto_presentacion" value=""/>
                                <input type="hidden" name="iva_impuesto" id="iva_impuesto" value="<?php echo Session::get('iva'); ?>"/>
                            ...
                            <div class="col-sm-6 m-t-20 m-t-0">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                <button type="submit" class="btn btn-success btn-guaxrdar">Aceptar</button>
            </div>
        </form>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <input type="hidden" name="id_prod_producto" id="id_prod_producto">
            ...
            <div class="modal-body">
                ...
                <div class="row mt-3">
                    <div class="col-12">
                    <a class="text-muted font-12 mr-auto" href="<?php echo URL; ?>/public/excel/productos.xlsx">Descargar formato de ejemplo para importar</a>
