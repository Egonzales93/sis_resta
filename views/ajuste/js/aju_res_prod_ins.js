...
var comboUnidadMedida = function(cod){
    // var var1=0,var2=0;1==cod?(var1=1,var2=1):2==cod?(var1=2,var2=4):3==cod&&(var1=3,var2=4):4==cod&&(var1=4,var2=4);
...
$('#cant_receta').keyup( function() {
    var opc=$("#id_med_receta").val();
    if(1==opc){var cal=($("#cant_receta").val()/1).toFixed(6);$("#valor_ing").text(cal)}
    else if(2==opc){var cal=($("#cant_receta").val()/1).toFixed(6);$("#valor_ing").text(cal)}
    else if(3==opc){var cal=($("#cant_receta").val()/1e3).toFixed(6);$("#valor_ing").text(cal)}
    else if(4==opc){var cal=($("#cant_receta").val()/1e6).toFixed(6);$("#valor_ing").text(cal)}
    else if(5==opc){var cal=($("#cant_receta").val()/1).toFixed(6);$("#valor_ing").text(cal)}
    else if(6==opc){var cal=($("#cant_receta").val()/1e3).toFixed(6);$("#valor_ing").text(cal)}
    else if(7==opc){var cal=($("#cant_receta").val()/2.20462).toFixed(6);$("#valor_ing").text(cal)}
    else if(8==opc){var cal=($("#cant_receta").val()/33.814).toFixed(7);$("#valor_ing").text(cal)}


    // else if(9==opc){var cal=($("#cant_receta").val()*33.814).toFixed(7);$("#valor_ing").text(cal)}
    // else if(10==opc){var cal=($("#cant_receta").val()/29.574).toFixed(6);$("#valor_ing").text(cal)}
    // else if(11==opc){var cal=($("#cant_receta").val()/1).toFixed(7);$("#valor_ing").text(cal)}
