...
//Session::set('item_detallado', $('#codigo_').val());
?>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            ...
                                            <?php foreach($this->TipoDocumento as $key): ?>
                                                <label class="btn waves-effect waves-light btn-secondary btn-tipo-doc-<?php echo $key['id_tipo_doc']; ?>">
                                            ...
                                            <?php endforeach; ?>
                                                ...
                                                <label class="btn waves-effect waves-light btn-secondary btn-tipo-doc-3">
                                                    <input type="radio" name="tipo_doc" value="3" autocomplete="off" checked="checked"> NOTA DE VENTA
                                                </label> -->
                                            </div>
                                        </th>
                                    </tr>
...
<script id="nvo-ped-det-template" type="text/x-jsrender" src="">
    ...
    <tr class="warning-element" style="border-left: 2px solid #ffb22b !important; background: #fefde3;">
        ...
        <td class="p-l-0 p-r-0">
            ...
            </b><span class="stock_producto_{{:id}}"></span>
        </td>
