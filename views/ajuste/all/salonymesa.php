...
<div class="row">
    ...
    <div class="col-lg-7">
        <div class="card" id="lizq-s" style="display: block;">         
            <div class="card-body">
                <div class="row text-center"><div class="col-sm-8 offset-sm-2"><h3><i class="ti ti-arrow-circle-left"></i><br>Agregue o seleccione un salón</h3><p>Debes agregar o seleccionar un salón para poder agregar, modificar o visualizar sus mesas</p></div></div>
            </div>
        </div>
