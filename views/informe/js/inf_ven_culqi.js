    ...
    .DataTable({
        ...
                return '<div class="text-right bold m-b-0"> '+moneda+' '+formatNumber(comision)+'</div>';
            ...
            {"data":null,"render": function ( data, type, row) {
                ...
                var iva = comision * data.iva;
                return '<div class="text-right bold m-b-0"> '+moneda+' '+formatNumber(iva)+'</div>';
            }},
            {"data":null,"render": function ( data, type, row) {
                var comision = data.total * 0.042;
                var iva = comision * data.iva;
                var total = data.total - comision - iva;
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            var iva = comision * 0.18;
            var monto_total = total - comision - iva;
            ...
            $('.ventas-iva').text(moneda+' '+formatNumber(iva));
